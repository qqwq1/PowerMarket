...
export default function CreateServicePage() {
  ...
  const [availabilities, setAvailabilities] = useState<AvailabilityPeriod[]>([{ startDate: "", endDate: "" }])

  const addAvailabilityPeriod = () => {
    setAvailabilities([...availabilities, { startDate: "", endDate: "" }])
  }
  ...
  const updateAvailability = (index: number, field: keyof AvailabilityPeriod, value: string) => {
